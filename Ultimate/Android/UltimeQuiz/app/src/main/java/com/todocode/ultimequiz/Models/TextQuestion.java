...
public class TextQuestion {
    public String questionType, hint, question_text, true_answer, false1,
            false2, false3,premium_or_not;
    public Integer id, category_id, subcategory_id, quiz_id, points, seconds, rank;

    public TextQuestion(String questionType, String hint, String question_text, String true_answer, String false1, String false2, String false3, String premium_or_not, Integer id, Integer category_id, Integer subcategory_id, Integer quiz_id, Integer points, Integer seconds, Integer rank) {
