...
public class LoginActivity extends AppCompatActivity {
    private Button googleLogin, facebookLogin, otpLogin, emailLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookLogin = (Button) findViewById(R.id.login_with_facebook);
        otpLogin = (Button) findViewById(R.id.login_with_otp);
        otpLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent registerPhone = new Intent(LoginActivity.this, RegisterWithPhoneNumber.class);
                startActivity(registerPhone);
            }
        });
        emailLogin = (Button) findViewById(R.id.login_with_email);
        emailLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent login = new Intent(LoginActivity.this, LoginWithEmailActivity.class);
                startActivity(login);
            }
        });
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (success.equals("done")){
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, url+"/api/players/getplayerdata", new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        Toast.makeText(LoginActivity.this, ""+getResources().getString(R.string.registered), Toast.LENGTH_SHORT).show();
                                        Intent referral = new Intent(LoginActivity.this, ReferralCodeActivity.class);
                            ...
                            Toast.makeText(LoginActivity.this, ""+getResources().getString(R.string.one_device), Toast.LENGTH_SHORT).show();
                        }
