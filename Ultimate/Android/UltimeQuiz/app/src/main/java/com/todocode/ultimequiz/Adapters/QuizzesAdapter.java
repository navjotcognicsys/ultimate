...
public class QuizzesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setOnItemClickListener(QuizzesAdapter.OnItemClickListener newsListener) {
        myListener = newsListener;
    }

    public QuizzesAdapter(Context context, List<Object> news) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case TYPE_NEW:
            default:
                View view = LayoutInflater.from(context).inflate(R.layout.single_quiz_layout, parent, false);
                return new QuizzesAdapter.NewsHolder(view, myListener);
        }
    }
